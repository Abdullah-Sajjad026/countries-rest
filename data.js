...
const cName = countryData.name.common;
const cPopulation = countryData.population;
const cRegion = countryData.region;
const cCapital = countryData.capital;
const cFlag = countryData.flags.svg;

export {cName, cPopulation, cRegion, cCapital, cFlag};
